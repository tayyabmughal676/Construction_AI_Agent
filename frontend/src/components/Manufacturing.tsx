      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-slate-800/60 backdrop-blur-xl border border-slate-700/50 p-6 rounded-2xl shadow-xl">
        <div>
          <h2 className="text-xl font-bold text-white flex items-center gap-2">
            <span>🏭</span> Fabrication Node — Inventory Stock
          </h2>
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          <input
            ...
            className="p-2.5 bg-slate-900/80 border border-slate-700 rounded-xl text-xs text-white placeholder-slate-500 focus:outline-none focus:border-blue-500 w-full sm:w-64"
          />
          <button
                  ...
                  <tr key={item.id} className="hover:bg-slate-700/30 transition-colors">
                    ...
                    <td className="p-4 text-right space-x-2">
                      ...
                      <button
                        ...
                        className="p-1.5 bg-blue-600/20 hover:bg-blue-600/40 text-blue-300 rounded-lg text-xs border border-blue-500/30 transition-all"
                        title="Edit Item"
                      >
                        ✏️
                      </button>
